      ...
      <section id="features" className="py-20 px-4 bg-primary/95 backdrop-blur-sm text-primary-foreground relative z-10">
        <div className="container mx-auto">
          <div className="mb-16">
            ...
            <p className="text-xl text-primary-foreground opacity-90 max-w-2xl">
        ...
        <div className="container mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-primary-foreground opacity-90">AI-powered safety detection for the modern workplace.</p>
            </div>
            <div>
              <h4 className="font-semibold mb-4">Product</h4>
              <div className="space-y-2 text-sm">
                <div>
                  <a href="#features" className="text-primary-foreground opacity-90 hover:text-primary-foreground">
                    Features
                  </a>
                </div>
                <div>
                  <a href="#integration" className="text-primary-foreground opacity-90 hover:text-primary-foreground">
                    Integration
                  </a>
                </div>
                <div>
                  <Link href="/dashboard" className="text-primary-foreground opacity-90 hover:text-primary-foreground">
                    Live Demo
                  </Link>
                </div>
              </div>
          ...
          <div className="border-t mt-8 pt-8 text-sm text-primary-foreground opacity-90">
